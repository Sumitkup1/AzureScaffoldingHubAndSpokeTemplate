...
$hub = [SubscriptionDetails]::new("3015bf6b-c772-408e-91dc-9e92670794d7","aehubrsg01")
$preProd = [SubscriptionDetails]::new("3015bf6b-c772-408e-91dc-9e92670794d7","aepreprodrsg01")
$prod = [SubscriptionDetails]::new("3015bf6b-c772-408e-91dc-9e92670794d7","aeprodrsg01")
$nonProd = [SubscriptionDetails]::new("3015bf6b-c772-408e-91dc-9e92670794d7","aenonprodrsg01")
...
Class SubscriptionDetails
{
    ...
    SubscriptionDetails([String]$SubscriptionId,[string]$ResourceGroup)
    {
...
$nonProdVnetObject = Get-AzVirtualNetwork -ResourceGroupName $nonProd._resourceGroup -verbose
#Logout 
